 ...
 * - urlExtractor: Optional function that returns the URL or false if the item
 *   should be  item should be skipped.
...
var processFeed = function(feedConfig, finalCallback) {
  async.auto({
    ...
    extract_urls: ['fetch_feed', function(callback, results) {
      var urlExtractor = results.config.urlExtractor || function(a) { return a.link; };
          items = results.fetch_feed.articles.map(urlExtractor);
